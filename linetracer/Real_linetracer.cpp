...
//        circle(result, pos, 3, Scalar(0, 255, 0), -1);      // 객체의 중심점을 잘 따라가고 있나 확인하는 점
//
...
//            if (label < 60)continue;
//
//
//            // x축과 y축의 거리간의 차이를 이용하여 주 라인 검출        
//            if ((integer.x <= 80 && integer.x >= -80) && ((integer.y >= -50) && (integer.y <= 50)))
//            {
//                pos = Point(x, y);
//                // 사각형            
//
//                error = poss.x - point.x;
